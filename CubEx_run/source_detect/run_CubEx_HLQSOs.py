...
sigma_v={"Lya":1.e4,"CIV":3e3,"SiIV":3e3,"CII":3e3,"NV":3e3,"OI":3e3,"OVI":3e3,"HeII":3e3} #km/s turbulent velocity
...
Inp_file = f'InpFile = "/disk/bifrost/yuanze/KBSS/Q{field}/QSO/q{field}-qso_icubes_wcs.PSFCONTSub.fits"'
